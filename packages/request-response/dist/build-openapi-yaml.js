...
async function buildOpenApiYaml(requestTypesPath, responseTypesPath, routes, version = "0.0.0", title = "", description = "", out = "openapi.yaml") {
    try {
        ...
        (0, utils_1.debug)("Build OpenAPI Yaml: ", { inputFilePaths });
        ...
        routeOptions.forEach((routeOptionObject) => {
            ...
            let requestSchema;
            (0, utils_1.debug)("Build OpenAPI Yaml: routeOptionObject.requestJsonSchema: ", routeOptionObject.requestJsonSchema, { routeOptionObject });
